...
**Project:** PT NEXUS CHEM BRIDGE
**Generated:** 2026-05-07 17:10:26
...
- **Body Font:** Noto Sans
- **Mood:** international, corporate, readable, clean, multilingual, precise
...
Use monospace only for legal identifiers, KBLI codes, and future product specification labels. Avoid futuristic display type for this brand.
...
For this project, keep motion minimal and commercial: Lenis smooth scroll, subtle parallax on image/material bands, opacity and transform reveals, no bounce easing, no cursor effects, and full `prefers-reduced-motion` support.
